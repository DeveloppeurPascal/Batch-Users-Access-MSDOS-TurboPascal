...
Ce projet contient une série de commandes MS-Dos programmées en 1993 sous [Turbo Pascal](https://fr.wikipedia.org/wiki/Turbo_Pascal). Elles permettent de gérer une liste d'utilisaeurs, leur connexion et leur déconnexion quand on est sous Dos.

Pour créer l'installeur il faut lancer INSTALL.BAT du dossier "release". Il modifiera le lanceur du DOS afin de forcer une connexion après redémarrage.

Evitez de l'utiliser en l'état. En terme de sécurisation des ordinateurs on a fait quand même un peu mieux en 30 ans, notamment au niveau du stockage des mots de passes.
